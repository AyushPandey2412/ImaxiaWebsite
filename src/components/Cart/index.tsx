...
//               <h2 className="font-medium text-[#A855F7] text-2xl">Your Cart</h2>
//       <button className="text-[#A855F7]">Clear Shopping Cart</button>
//             </div>
...
//   className="w-96 mx-auto flex justify-center font-medium text-white bg-[#A855F7] py-[13px] px-6 rounded-md ease-out duration-200 hover:bg-[#7C3AED]"
// >
//   Continue Shopping
// </Link>
//           </div>
      ...
      {cartItems.length > 0 ? (
        <section className="overflow-hidden py-20 bg-gray-2">
          <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
            ...
            <div className="flex flex-wrap items-center justify-between gap-5 mb-7.5">
              <h2 className="font-medium text-[#A855F7] text-2xl">Your Cart</h2>
              <button className="text-[#A855F7] text-sm hover:underline">
                Clear Shopping Cart
              </button>
            </div>
            ...
            <div className="bg-white rounded-[10px] shadow-1">
              ...
              <div className="hidden lg:flex items-center py-5.5 px-7.5 border-b border-gray-3">
                <div className="min-w-[400px]">
              ...
              {/* Cart items — no forced min-width */}
        ...
        <div className="text-center mt-8 px-4">
          ...
          <p className="pb-6 text-gray-500">Your cart is empty!</p>
          <Link
            href="/shop-with-sidebar"
            className="w-full max-w-xs mx-auto flex justify-center font-medium text-white bg-[#7C3AED] py-[13px] px-6 rounded-md ease-out duration-200 hover:bg-[#6D28D9]"
          >
            Continue Shopping
          </Link>
        </div>
