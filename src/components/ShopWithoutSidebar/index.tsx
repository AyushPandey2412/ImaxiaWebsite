...
const paginatedProducts = shopData.slice(
  ...
  <span className="text-dark">
    {paginatedProducts.length} of {shopData.length}
  </span>{" "}
  Products
</p>
                  ...
                  <div className="flex items-center gap-2.5">
                    <button
                      ...
                      } flex items-center justify-center w-10.5 h-9 rounded-[5px] border ease-out duration-200 hover:bg-[#A855F7] hover:border-[#A855F7] hover:text-white
`}
                    >
                      <svg
