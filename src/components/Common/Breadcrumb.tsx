...
const Breadcrumb = ({ title, pages }) => {
  return (
    ...
    // <div className="overflow-hidden shadow-breadcrumb pt-[120px] sm:pt-[120px] lg:pt-[110px] xl:pt-[110px]">
    <div className="overflow-hidden shadow-breadcrumb pt-[100px] sm:pt-[110px] lg:pt-[95px] xl:pt-[60px]">
