...
//     params.set("min", String(Math.floor(e[0])));
//     params.set("max", String(Math.ceil(e[1])));
...
//             <span className="block px-3 py-1.5">{min}</span>
//           </div>

//           <div className="text-custom-xs text-dark-4 flex rounded border border-gray-3/80">
//             <span className="block border-r border-gray-3/80 px-2.5 py-1.5">$</span>
//             <span className="block px-3 py-1.5">{max}</span>
//           </div>
//         </div>
//       </div>
//     </div>
